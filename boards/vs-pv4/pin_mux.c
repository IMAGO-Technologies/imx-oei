...
{
    /* RAM_MODE0 */
    IOMUXC_SetPinMux(IOMUXC_PAD_SAI1_TXC__GPIO1_IO_BIT12, 0U);
    IOMUXC_SetPinConfig(IOMUXC_PAD_SAI1_TXC__GPIO1_IO_BIT12, IOMUXC_PAD_PU(1U));

    /* RAM_MODE1 */
    IOMUXC_SetPinMux(IOMUXC_PAD_SAI1_RXD0__GPIO1_IO_BIT14, 0U);
    IOMUXC_SetPinConfig(IOMUXC_PAD_SAI1_RXD0__GPIO1_IO_BIT14, IOMUXC_PAD_PU(1U));
